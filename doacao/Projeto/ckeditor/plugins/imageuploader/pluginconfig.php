...
$username = "victorassis"; $password = '06e1e4e236627741212837c5f10c0d5b';

    $useruploadfolder = "sistemaDoacoes/Projeto/img_uploads/";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "sistemaDoacoes/Projeto/img_uploads/";
        

    $useruploadfolder = "sistemaDoacoes/Projeto/ckeditor/plugins/imageuploader/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "sistemaDoacoes/Projeto/ckeditor/plugins/imageuploader/uploads";
