...
if(isset($_POST["dataInicial"]) && isset($_POST["dataFinal"]) && isset($_POST["opcao"]) && $_POST["dataInicial"] != "" && $_POST["dataFinal"] != "" 
	...
	if(isset($despesas)){
		...
		<div class="container">	
			...
			<caption>Relatório de despesas de <?php echo $di ?> à <?php echo $df ?> </caption>
			  <thead>
	...
	if(isset($doacoes)){
		...
		<div class="container">	
			<table class="table table-hover table-white table-responsive-xm">
			<caption>Relatório de doações de <?php echo $di ?> à <?php echo $df ?> </caption>
			  <thead>
			    <tr class="table-success">
		    	...
		    	<tr>
		    		<?php foreach($doadores as $doador){
		      		...
		      		<th scope="row"><?php echo $doacao->dataDoacao; ?></th>
